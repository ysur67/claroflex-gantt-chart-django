...
// Aceptar el informe de Círculo de Responsabilidades 
...
{  
	...
	// Fecha de inicio de gráficos según el plan
	...
	// Repase las tareas y determine los límites de los gráficos
...
function render_project_scheme_line(task_id, static_task_obj)
{
	...
	$.each(tasks_obj, function(i, task_data){
		...
		// Número de días en los que la tarea estuvo atrasada 
...
function draw_line_dependence()
{
	$('.line').each(function(){
		...
		// Encontramos la gráfica de la tarea anterior
...
function get_task_dates(this_task_data)
{
	...
	{ 
		// El número de días en los que se cambia la tarea en función de las tareas anteriores
		task_offset_days = get_task_offset_days(prepends_tasks, this_task_data);
		
		// Designamos la fecha de inicio y finalización, teniendo en cuenta el turno
	...
	// La fecha de finalización prevista de la tarea, teniendo en cuenta todos los turnos (si los hay)
	...
	// Si la tarea aún no se ha completado y la fecha de vencimiento ya está vencida
...
function get_task_offset_days(prepends_tasks, this_task_data)
{
	...
	$.each(prepends_tasks, function(i,j){
		...
		if(pre_iter_task_date_finish)
		{
			...
			// Si hay días de turno de tareas anteriores
...
// Aceptar el informe de Círculo de obligaciones 
