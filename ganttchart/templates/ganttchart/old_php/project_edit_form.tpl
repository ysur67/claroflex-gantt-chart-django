...
<div class="title_add_form">Modificar los datos del proyecto</div>
...
<div class="right"></div><div class="left"></div><div class="btn_cont">Guardar proyecto</div></a> <a class="cancel_add_btn" onclick="close_popup('', 1);tinyMCE.editors['project_desc'].destroy()" href="javascript:;">Cancelación</a>
<div class="clear"></div>
</div> 
