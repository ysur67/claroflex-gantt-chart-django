...
<div class="title_add_form">Tareas actuales por proyectos</div>
<div class="project_scheme d_none" id="project_scheme" style="margin-bottom:0px">
...
tasks_obj = new Object({TASKS_OBJ});
scheme_pre_init(1);
</script>
