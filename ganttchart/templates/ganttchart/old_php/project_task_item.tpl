...
<div style="margin:5px 0px 8px 0px"><a href="javascript:;" onclick="show_project_tasks_comments('{TASK_ID}')" class="link_proc">Reporte  <span class="new_count" id="new_task_report_count_{TASK_ID}">{TASK_REPORTS_COUNT}</span></a>
...
<td class="prt_delete_bl"><a href="javascript:;" class="delete" onclick="delete_project_task('{TASK_ID}')" title="Eliminar tarea"></a></td>
</tr>
