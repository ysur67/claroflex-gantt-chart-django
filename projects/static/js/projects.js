...
function add_project() {
    ...
    // 	name : project_name,
    // 	description : project_desc,
    // 	tasks : $.toJSON(project_tasks_arr),
...
function get_project_form_tasks() {
    ...
    $('.task').each(function () {
        ...
        obj['close_date'] = date_finish;
        obj['user'] = user_id;
        obj['description'] = task_desc;
        // obj['related_task'] = after_task_id;
        obj['id'] = task_id;
        // obj['num'] = num;
